...
/******************************************************************************/
    ...
    int& keyMapping::operator[](int index) {
        if (0 <= index && index <= 8) {
            switch(index) {
                case(0): return up;
                case(1): return down;
                ...
                case(5): return nextWeapon;
                case(6): return previousWeapon;
                case(7): return explode;
                case(8): return lastCode;
    ...
    string keyMapping::name(int index) {
        if (0 <= index && index <= 8) {
            switch(index) {
                case(0): return "up";
                case(1): return "down";
                ...
                case(3): return "right";
                case(4): return "inventory";
                case(5): return "next weapon";
                case(6): return "previous weapon";
                case(7): return "explode";
                case(8): return "broadcast last code";
                default: return "badkeyindex";
            }
        }
        else if (9 <= index && index <= 18) {
            return "broadcast code " + to_string(index - 9);
        }
        else {
            return "badkeyindex";
        }
