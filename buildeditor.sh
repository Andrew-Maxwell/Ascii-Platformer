...
g++ -g -c -I /opt/raylib/src entitymeta.cpp -o entitymeta.o -O3 -Wall
g++ -g -c -I /opt/raylib/src layer.cpp -o layer.o -O3 -Wall
g++ -g -c -I /opt/raylib/src dummyentity.cpp -o dummyentity.o -O3 -Wall
g++ -g -c -I /opt/raylib/src editables.cpp -o editables.o -O3 -Wall
g++ -g -c -I /opt/raylib/src charfills.cpp -o charfills.o -O3 -Wall
